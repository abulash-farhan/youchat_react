...
const __dirname1 = path.resolve(); // resolving the paths

if (process.env.NODE_ENV === "production") {
  app.use(express.static(path.join(__dirname1, "/frontend/build"))); // the react frontend is generally at frontend/build
